...
public class ProveedorApp extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos de Provedores"));
    ...
    private void obtenerTabla() {
        ...
        txtId.setText(String.valueOf(prov.getId()));
        txtDescripcion.setText(prov.getDes());
        txtDir.setText(prov.getDir());
        txtTel.setText(prov.getTel());
    ...
    public void guardarUno(){
        if(txtDescripcion.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Falta descripción del proveedor.");
        }
        else{
    ...
    public void guardarDos(){
       if(btnGuardar.getText().equals("Guardar")){
            ...
            prov.setDes(txtDescripcion.getText());
            prov.setDir(txtDir.getText());
            prov.setTel(txtTel.getText());
            prov.setCuit(txtCuit.getText());
            st.save(prov);
            st.getTransaction().commit();
            st.close();
            JOptionPane.showMessageDialog(null, "Registro de proveedor guardado.");
            cargarTabla();
            arranque();
       }else{
            st = HibernateUtil.getSessionFactory().openSession();
            st.beginTransaction();
            int selectedRow = this.tblProveedor.getSelectedRow();
            int idProv = Integer.parseInt(String.valueOf(model.getValueAt(selectedRow, 0)));
            Proveedor prov = (Proveedor)st.load(Proveedor.class, idProv);
            prov.setDes(txtDescripcion.getText());
            prov.setDir(txtDir.getText());
            ...
            st.getTransaction().commit();
            st.close();
            JOptionPane.showMessageDialog(null, "Registro de proveedor actualizado.");
            cargarTabla();
            arranque();
       }
    }
    ...
    private void eliminar() {
        int opc = JOptionPane.showConfirmDialog(null,"¿Desea eliminar este Proveedor?", 
        ...
        if(opc == 1){ 
            ...
            int idProv = Integer.parseInt(valueAt.toString());
            Proveedor t = (Proveedor) st.load(Proveedor.class, idProv);
            st.delete(t);
            st.getTransaction().commit();
            st.close();
    ...
    private void defaultTableModel() {
        tblProveedor.getColumnModel().getColumn(0).setPreferredWidth(25);
        tblProveedor.getColumnModel().getColumn(1).setPreferredWidth(200);
    ...
    private void cargarTabla() {
        st = HibernateUtil.getSessionFactory().openSession();
        st.beginTransaction();
        List<Proveedor> lista = st.createQuery("from Proveedor").list();
        for (Iterator<Proveedor> it = lista.iterator(); it.hasNext();) {
            Proveedor cli = it.next();
